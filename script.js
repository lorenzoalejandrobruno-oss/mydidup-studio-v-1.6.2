...
const APP_NEWS_HISTORY = [
    ...
    { 
        ...
        date: "Oggi", 
        news: [
            "Fix Definitivo iPhone: Blindatura strutturale delle card per impedire deformazioni post-login.",
            "UI: Ottimizzato il padding e il contenimento dei testi per nomi utente lunghi.",
            "System: Incrementata versione cache a v37 per forzare il refresh degli stili."
        ]
    },
    { 
        v: "1.6.9", 
    ...
    { 
        ...
        date: "Oggi", 
        news: [
            "Fix iPhone: Forzato il contenimento dei rettangoli della Home (minmax grid) per impedire l'allargamento post-login.",
            "UI: Ottimizzata la gestione degli spazi nell'header per nomi utente lunghi provenienti dal cloud.",
            "System: Incrementata versione cache a v35 per riflettere le modifiche strutturali."
        ]
    },
    { 
        v: "1.6.7", 
    ...
    { 
        ...
        date: "Oggi", 
        news: [
            "Branding: Ripristinata l'icona della sagoma utente (omino) come richiesto.",
            "System: Incrementata versione cache a v29 per il refresh degli asset."
        ]
    },
    { 
        v: "1.6.1", 
        date: "Oggi", 
        news: [
            "Branding: Sostituita l'icona del profilo con uno zaino stilizzato per un look più scolastico.",
            "System: Incrementata versione cache a v28 per l'aggiornamento degli asset."
        ]
    },
    { 
        v: "1.6.0", 
        ...
        news: [
            "Branding: Ripristinata l'icona della sagoma utente (omino) come richiesto.",
            "System: Incrementata versione cache a v27 per l'aggiornamento degli asset."
        ]
    },
    { 
        v: "1.5.9", 
        date: "Oggi", 
        news: [
            "Fix Logo: Risolto problema di visualizzazione del logo con cache busting aggressivo (v=3).",
            "System: Incrementata versione cache a v26 per forzare il refresh."
        ]
    },
    { 
        v: "1.5.8", 
        date: "Oggi", 
        news: [
            "Branding: Sostituita l'icona della sagoma utente con un'icona zaino per un look più scolastico.",
            "System: Incrementata versione cache a v25 per l'aggiornamento degli asset."
        ]
    },
    { 
        v: "1.5.7", 
        date: "Oggi", 
        news: [
            "Ripristino Logo: Configurato l'utilizzo dell'icona remota per garantire la visibilità su tutti i dispositivi.",
            "System: Incrementata versione cache a v24."
        ]
    },
    { 
        v: "1.5.6", 
        date: "Oggi", 
        news: [
            "Fix: Risolto definitivamente il bug nel Rapporto Presenze (Monte ore 1221/1301).",
            "Branding: Consolidato l'utilizzo di 'image_e1b2d9.png' con cache busting v2.",
            "System: Incrementata la versione del Service Worker per forzare la pulizia su iOS."
        ]
    },
    { 
        v: "1.5.5", 
        date: "Oggi", 
        news: [
            "Configurazione: Aggiornato il monte ore annuale TrED (1221h per 1°, 3° e 4° anno; 1301h per il 2° anno)."
        ]
    },
    { 
        v: "1.5.4", 
        date: "Oggi", 
        news: [
            "Logica Assenze: Rapporto presenze ricalcolato sul monte ore totale (1320h/1221h).",
            "Alert: Sistema di avviso ricalibrato sul limite legale del 25% delle ore totali.",
            "UI: Ripristinate le etichette standard 'Presenze' e 'Assenze' nel grafico dashboard.",
            "Automation: Sincronizzazione automatica di versione e novità su tutti i pannelli."
        ]
    }
];

/** Flag per l'annullamento dell'importazione PDF */
let pdfImportAborted = false;

/**
 * Imposta il flag per annullare l'importazione del PDF.
 */
window.cancelPDFImport = function() {
    pdfImportAborted = true;
};


/** Controlla se l'utente ha già visualizzato l'ultima versione */
function hasNewVersion() {
    return localStorage.getItem('lastSeenVersion') !== CURRENT_VERSION;
}

/**
 * Materie di default utilizzate per l'inizializzazione dell'applicazione.
 */
const importedDefaultSubjects = [
    { id: 9, name: "ARTE", target: 6, color: "#FF9500", grades: [], scrutinio: { primo: { voto: '-', assenze: 0, previsione: null }, secondo: { voto: '-', assenze: 0, previsione: null } } },
    { id: 2, name: "FISICA", target: 6, color: "#AF52DE", grades: [], scrutinio: { primo: { voto: '-', assenze: 0, previsione: null }, secondo: { voto: '-', assenze: 0, previsione: null } } },
    { id: 3, name: "INFORMATICA", target: 7, color: "#007AFF", grades: [], scrutinio: { primo: { voto: '-', assenze: 0, previsione: null }, secondo: { voto: '-', assenze: 0, previsione: null } } },
    { id: 4, name: "LINGUA E LETTERATURA INGLESE", target: 6, color: "#5856D6", grades: [], scrutinio: { primo: { voto: '-', assenze: 0, previsione: null }, secondo: { voto: '-', assenze: 0, previsione: null } } },
    { id: 5, name: "LINGUA E LETTERATURA ITALIANA", target: 6, color: "#FF3B30", grades: [], scrutinio: { primo: { voto: '-', assenze: 0, previsione: null }, secondo: { voto: '-', assenze: 0, previsione: null } } },
    { id: 6, name: "MATEMATICA", target: 6, color: "#34C759", grades: [], scrutinio: { primo: { voto: '-', assenze: 0, previsione: null }, secondo: { voto: '-', assenze: 0, previsione: null } } },
    { id: 7, name: "STORIA E GEOGRAFIA", target: 6, color: "#5AC8FA", grades: [], scrutinio: { primo: { voto: '-', assenze: 0, previsione: null }, secondo: { voto: '-', assenze: 0, previsione: null } } },
    { id: 8, name: "SCIENZE MOTORIE E SPORTIVE", target: 8, color: "#FF2D55", grades: [], scrutinio: { primo: { voto: '-', assenze: 0, previsione: null }, secondo: { voto: '-', assenze: 0, previsione: null } } },
    { id: 1, name: "Scienze della Terra", target: 6, color: "#FFCC00", grades: [], scrutinio: { primo: { voto: '-', assenze: 0, previsione: null }, secondo: { voto: '-', assenze: 0, previsione: null } } },
    { id: 10, name: "RELIGIONE", target: 6, color: "#94a3b8", grades: [], scrutinio: { primo: { voto: '-', assenze: 0, previsione: null }, secondo: { voto: '-', assenze: 0, previsione: null } } },
    { id: 11, name: "EDUCAZIONE CIVICA", target: 6, color: "#10b981", grades: [], scrutinio: { primo: { voto: '-', assenze: 0, previsione: null }, secondo: { voto: '-', assenze: 0, previsione: null } } },
    { id: 12, name: "COMPORTAMENTO", target: 6, color: "#3b82f6", grades: [], scrutinio: { primo: { voto: '-', assenze: 0, previsione: null }, secondo: { voto: '-', assenze: 0, previsione: null } } },
];
...
// =======================================================
window.currentUser = null; // Global variable for current user

/**
 * Restituisce il monte ore totale annuale in base all'anno di corso (TrED).
 */
function getTotalAnnualHours() {
    switch (parseInt(currentTredYear)) {
        case 1: return 1221; // Monte ore totale TrED 1
        case 2: return 1301; // Monte ore totale TrED 2
        case 3: return 1221; // Monte ore totale TrED 3
        case 4: return 1221; // Monte ore totale TrED 4
        default: return 1221; // Valore di default per sicurezza
    }
}
...
// ========================================================
// 1.3 LOGICA MATERIE SPECIALI (COMPORTAMENTO ED ED. CIVICA)
// ========================================================
function ensureSpecialSubjects() {
    let changed = false;
    ["EDUCAZIONE CIVICA", "COMPORTAMENTO"].forEach(specName => {
        if (!schoolData.some(s => s.name.toUpperCase() === specName)) {
            const def = importedDefaultSubjects.find(d => d.name.toUpperCase() === specName);
            if (def) {
                schoolData.push(JSON.parse(JSON.stringify(def)));
                changed = true;
            }
        }
    });
...
// ========================================================
// 1.4 MOTORE DI ORDINAMENTO GLOBALE
// ========================================================
function sortSubjectsOfficially(data) {
    // Mappa di priorità basata sulla richiesta specifica dell'utente
    const getPriority = (name) => {
        ...
        if (n.includes("SCIENZE")) return 7;
        if (n.includes("DISEGNO") || n.includes("ARTE")) return 8;
        if (n.includes("MOTORIE") || n.includes("SPORTIVE")) return 9;
        if (n.includes("RELIGIONE")) return 10;
        if (n.includes("EDUCAZIONE CIVICA") || n.includes("ED. CIVICA")) return 11;
        if (n.includes("COMPORTAMENTO")) return 12;
        return 99; // Altre materie alla fine
    };
    ...
    return data.sort((a, b) => {
        ...
        return a.name.localeCompare(b.name); // Alfabetico se hanno stessa priorità
    });
}
...
function initializeSchoolData() {
    ...
    schoolData = JSON.parse(localStorage.getItem(getTredKey('myDidupDataDesktop'))) || [];
    ...
    // If no schoolData exists for the current year, use default subjects
    if (!localStorage.getItem(getTredKey('myDidupDataDesktop')) || schoolData.length === 0) {
        schoolData = JSON.parse(JSON.stringify(importedDefaultSubjects)); // Deep copy to avoid modifying the default
        localStorage.setItem(getTredKey('myDidupDataDesktop'), JSON.stringify(schoolData));
    }

    // Assicuriamoci che le materie speciali esistano e siano salvate
    ensureSpecialSubjects();

    // Applichiamo l'ordinamento richiesto globalmente all'avvio
    sortSubjectsOfficially(schoolData);
    ...
    renderBottomNav();
    renderHomeNews();
    initializePrevisione(); // Ensure previsione field is present for all subjects/periods
    updateTredYearUI();
    renderVersionHistory();
    recalculateDesktopSystem();

    // Richiesta permessi notifiche per iOS (funziona solo se installata sulla Home)
...
async function requestNotificationPermission() {
    ...
    if (Notification.permission === 'default') {
        ...
        if (permission === 'granted') showToast("Notifiche attivate!", "success");
    }
}
...
function triggerLocalNotification(title, body) {
    if ('serviceWorker' in navigator && Notification.permission === 'granted') {
        navigator.serviceWorker.ready.then(reg => {
            reg.showNotification(title, { body, icon: 'https://cdn-icons-png.flaticon.com/512/747/747376.png', badge: 'https://cdn-icons-png.flaticon.com/512/747/747376.png' });
        });
    }
}
...
function switchDesktopTab(tabId) {
    ...
    if (document.getElementById('menu-overlay')) {
        document.getElementById('menu-overlay').classList.remove('open');
        document.body.classList.remove('menu-open'); // Sblocca lo scroll dopo la navigazione e chiusura menu
    }
}
...
function renderBottomNav() {
    ...
    // Badge sul menu se c'è un aggiornamento e la tab Info non è in primo piano
    const infoInSlots = [navSettings.slot1, navSettings.slot2, navSettings.slot3].includes('info');
    const showMenuBadge = !infoInSlots && hasNewVersion();
    ...
    nav.innerHTML = `
        <div class="nav-btn ${activeTabId === navSettings.slot1 ? 'active' : ''}" id="btn-nav-${navSettings.slot1}" onclick="switchDesktopTab('${navSettings.slot1}')">
            ...
            ${navSettings.slot1 === 'info' && hasNewVersion() ? '<span class="nav-badge"></span>' : ''}
        </div>
        <div class="nav-btn ${activeTabId === navSettings.slot2 ? 'active' : ''}" id="btn-nav-${navSettings.slot2}" onclick="switchDesktopTab('${navSettings.slot2}')">
            ...
            ${navSettings.slot2 === 'info' && hasNewVersion() ? '<span class="nav-badge"></span>' : ''}
        </div>
        <div class="nav-btn ${activeTabId === navSettings.slot3 ? 'active' : ''}" id="btn-nav-${navSettings.slot3}" onclick="switchDesktopTab('${navSettings.slot3}')">
            ...
            ${navSettings.slot3 === 'info' && hasNewVersion() ? '<span class="nav-badge"></span>' : ''}
        </div>
        <div class="nav-btn" id="btn-nav-menu" onclick="toggleFullMenu()">
            ...
            ${showMenuBadge ? '<span class="nav-badge"></span>' : ''}
        </div>
    `;
}
...
window.syncFromCloud = (cloudData) => {
    ...
    try {
        ...
        if (yd) {
            ...
            // Riapplichiamo il controllo sulle materie speciali per evitare che il cloud le rimuova
            ensureSpecialSubjects();
            sortSubjectsOfficially(schoolData);
...
function updateUserUI(name, uClass) {
    const initial = "👤"; // Forza l'icona utente
    const formattedName = name ? name : "Studente";
    
    if(document.getElementById('display-name')) document.getElementById('display-name').innerText = formattedName;
    if(document.getElementById('display-name-welcome')) document.getElementById('display-name-welcome').innerText = formattedName;
    const logoUrl = "https://cdn-icons-png.flaticon.com/512/747/747376.png";
    if(document.getElementById('user-avatar')) document.getElementById('user-avatar').innerHTML = `<img src="${logoUrl}" alt="Logo" style="width: 24px; height: 24px;">`;
    if(document.getElementById('user-avatar-header')) document.getElementById('user-avatar-header').innerHTML = `<img src="${logoUrl}" alt="Logo" style="width: 32px; height: 32px;">`;
    if(document.getElementById('display-name-menu')) document.getElementById('display-name-menu').innerText = formattedName;
    if(document.getElementById('user-avatar-menu')) document.getElementById('user-avatar-menu').innerHTML = `<img src="${logoUrl}" alt="Logo" style="width: 24px; height: 24px;">`;
...
function toggleSidebar(e) {
    if (e) e.stopPropagation(); // Impedisce al click di propagarsi al document
    // La classe 'menu-open' sul body è gestita solo dal menu overlay a schermo intero.
    // La sidebar ha il suo overflow-y: auto e non deve bloccare lo scroll del body.
...
function toggleFullMenu() { 
    ...
    if (menu.classList.contains('open')) {
        ...
        // La classe body.menu-open viene rimossa qui, se il menu viene chiuso dal pulsante stesso.
        // Se una tab viene selezionata, switchDesktopTab gestirà la rimozione.
...
/**
 * Applica la dimensione del carattere scelta dall'utente.
 * @param {number} size - La dimensione del carattere in pixel.
 */
/**
 * Imposta la dimensione del testo globale e salva la preferenza.
 * @param {string} size - 'small', 'medium' o 'large'
 */
function setTextSize(size) {
    // 1. Applica l'attributo al tag HTML
    document.documentElement.setAttribute('data-text-size', size);
    
    // 2. Salva nel localStorage
    localStorage.setItem('textSize', size);
    
    // 3. Aggiorna l'UI del triangolo
    document.querySelectorAll('.triangle-level').forEach(el => {
        el.classList.toggle('active', el.dataset.size === size);
    });

    // 4. Aggiorna la label testuale nel modale
    const label = document.getElementById('text-size-label-display');
    if (label) {
        const labels = { small: 'Piccolo', medium: 'Medio', large: 'Grande' };
        label.innerText = labels[size];
    }
}
...
function openModal(id) { 
    ...
    if (menu && menu.classList.contains('open')) {
        ...
        document.body.classList.remove('menu-open'); // Fix: Ensure body scroll is re-enabled
    }
    if (id === 'vacations-modal') {
        resetVacationForm();
        renderVacationsList();
    }
    if (id === 'bulk-attendance-modal') {
        document.getElementById('bulk-attendance-tbody').innerHTML = '';
        addBulkAttendanceRow(); // Inizia con una riga vuota
    }
}
...
// Inizializza la preferenza della dimensione del carattere all'avvio
document.addEventListener('DOMContentLoaded', loadFontSizePreference);
...
function filterGradesBySpecificPeriod(grades, period) {
    ...
    return grades.filter(g => {
        const gradeTime = parseDateSafe(g.date).setHours(0,0,0,0);
        if(period === 'primo') {
            const start = parseDateSafe(termSettings.p1_start).setHours(0,0,0,0);
            const end = parseDateSafe(termSettings.p1_end).setHours(23,59,59,999);
            return gradeTime >= start && gradeTime <= end;
        }
        if(period === 'secondo') {
            const start = parseDateSafe(termSettings.p1_end).setHours(23,59,59,999);
            const end = parseDateSafe(termSettings.p2_end).setHours(23,59,59,999);
            return gradeTime > start && gradeTime <= end;
        }
        return true; // intero
    });
...
function renderHomeDetailedAverages() {
    ...
    let periodName = currentPeriod === 'primo' ? '1° Quadrimestre' : (currentPeriod === 'secondo' ? 'Scrutinio Finale' : 'Intero Anno');
    ...
    if (currentPeriod === 'secondo' && avgs.primo) {
        html += `<div>Precedente (1° Quad): <b>${avgs.primo.toFixed(2)}</b></div>`; // Keep this as 1° Quad for clarity
    } else if (currentPeriod === 'intero') { // For intero, show both quadrimestres
        html += `<div>1° Quad: <b>${avgs.primo?.toFixed(2) || '--'}</b> | Scrutinio Finale: <b>${avgs.secondo?.toFixed(2) || '--'}</b></div>`;
    }
...
function updateGlobalAverageUI(numericAvg, grandCount) {
    ...
    if (avgDisplay && lastAvg !== 0 && Math.abs(numericAvg - lastAvg) > 0.001) { // Check lastAvg !== 0 to prevent animation on initial load
        const isUp = numericAvg > lastAvg;
        toggleAvgAnimation(avgDisplay, circleStroke, isUp, numericAvg);
    }
...
function toggleAvgAnimation(display, border, isUp, numericAvg) {
    ...
    if (numericAvg && numericAvg !== 0) display.classList.add(isUp ? 'avg-up' : 'avg-down'); // Only animate if avg is not zero
...
function renderAllDashboardSections(numericAvg, monthlyBucket, hasData) {
    ...
    if(badge) badge.innerText = hasData ? `Media Periodo: ${numericAvg.toFixed(2)}` : "Media Periodo: N.D."; // This is fine, it's a generic label

    const bannerCont = document.getElementById('tab-voti-header-info');
    if(bannerCont) {
        const periodName = currentPeriod === 'primo' ? '1° Quadrimestre' : (currentPeriod === 'secondo' ? 'Scrutinio Finale' : 'Intero Anno');
    ...
    renderDiarioSection();
    renderSubjectsAccordion(); // Ensure subjects accordion is rendered after recalculation
    renderRemindersSection(); // Moved after renderSubjectsAccordion
    renderEventsSection();
    ...
    renderTimetable();
    // populateTimetableSelects(); // Redundant, populateSubjectSelects already handles tt-subject-select
...
/**
 * Calcola la media aritmetica semplice dei voti numerici in un array.
 */
function calculateArithmeticAvg(grades) {
    const numericGrades = grades.filter(g => !isNaN(parseFloat(g.value)));
    if (numericGrades.length === 0) return null;
    const sum = numericGrades.reduce((acc, g) => acc + parseFloat(g.value), 0);
    return sum / numericGrades.length;
}

/**
 * Permette di modificare manualmente la previsione del voto di scrutinio.
 */
window.editScrutinioPrediction = (subId) => {
    const sub = schoolData.find(s => s.id === subId);
    if (!sub) return;
    const currentScrutData = sub.scrutinio[currentScrutinioPeriod];
    const currentGrades = filterGradesBySpecificPeriod(sub.grades || [], currentScrutinioPeriod);
    const currentAvg = calculateArithmeticAvg(currentGrades);
    const autoSuggested = currentAvg !== null ? Math.round(currentAvg) : "";
    const currentPred = currentScrutData.previsione || autoSuggested;

    const newVal = prompt(`Modifica previsione per ${sub.name}:`, currentPred);
    if (newVal !== null) {
        currentScrutData.previsione = newVal;
        updateStorage('myDidupDataDesktop', schoolData);
        showToast("Previsione aggiornata!");
        renderScrutinioTable();
    }
};

/**
 * Approva massivamente tutti i voti consigliati per il periodo corrente.
 */
window.applyAllSuggestedGrades = () => {
    let count = 0;
    schoolData.forEach(sub => {
        const scrut = sub.scrutinio[currentScrutinioPeriod];
        const grades = filterGradesBySpecificPeriod(sub.grades || [], currentScrutinioPeriod);
        const avg = calculateArithmeticAvg(grades);
        const suggested = scrut.previsione || (avg !== null ? Math.round(avg).toString() : null);
        
        if (suggested) {
            scrut.voto = suggested.toString();
            count++;
        }
    });
    updateStorage('myDidupDataDesktop', schoolData);
    showToast(`Approvati ${count} voti consigliati!`, "success");
    renderScrutinioTable();
};

/**
 * Applica il voto suggerito allo scrutinio della materia.
 */
window.applySuggestedGrade = (subId, grade) => {
    const sub = schoolData.find(s => s.id === subId);
    if (sub && grade) {
        sub.scrutinio[currentScrutinioPeriod].voto = grade.toString();
        updateStorage('myDidupDataDesktop', schoolData);
        showToast(`Applicato voto ${grade} a ${sub.name}`);
        renderScrutinioTable();
    }
};
...
function renderScrutinioTable() {
    ...
    // schoolData è già ordinato globalmente da initializeSchoolData
    const sortedSchoolData = sortSubjectsOfficially([...schoolData]);

    const getNumericScrutinioVoto = (voto) => {
        if (voto === '-' || voto === null || voto === undefined) return NaN;
        const num = parseFloat(voto);
        return isNaN(num) ? NaN : num;
    };

    // Calculate overall scrutinio average for admission
    let totalScrutinioGradesSum = 0;
    let totalScrutinioGradesCount = 0;

    sortedSchoolData.forEach(s => {
        const currentScrutData = s.scrutinio[currentScrutinioPeriod];
        const numericVoto = getNumericScrutinioVoto(currentScrutData.voto);
        if (!isNaN(numericVoto)) {
            totalScrutinioGradesSum += numericVoto;
            totalScrutinioGradesCount++;
        }
    });

    let overallScrutinioAverage = 0;
    if (totalScrutinioGradesCount > 0) {
        overallScrutinioAverage = totalScrutinioGradesSum / totalScrutinioGradesCount;
    }

    const isAdmitted = overallScrutinioAverage >= 6; // Assuming 6 is the passing grade
    const admissionStatusText = isAdmitted ? "AMMESSO/A" : "NON AMMESSO/A";
    const admissionRectColor = isAdmitted ? "#4CAF50" : "#FF3B30";

    const admissionRectangleHtml = `
        <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 25px; border-radius: 24px; background-color: ${admissionRectColor}; color: white; margin-bottom: 30px; text-align: center; box-shadow: 0 12px 30px -5px ${admissionRectColor}66;">
            <div style="font-size: 28px; font-weight: 900; text-transform: uppercase; letter-spacing: 2px; margin-bottom: 5px;">${admissionStatusText}</div>
            <div style="font-size: 20px; font-weight: 700; opacity: 0.95;">Media Totale: ${overallScrutinioAverage.toFixed(2)}</div>
        </div>
    `;

    // Inject or update the admission rectangle ONLY for the 'secondo' (final) scrutinio period
    const admissionRectElement = document.getElementById('admission-status-rectangle');
    if (currentScrutinioPeriod === 'secondo') {
        if (!admissionRectElement) {
            const scrutinioTab = document.getElementById('tab-scrutinio');
            const newRect = document.createElement('div');
            newRect.id = 'admission-status-rectangle';
            scrutinioTab.insertBefore(newRect, scrutinioTab.querySelector('.scrutinio-layout-split'));
        }
        document.getElementById('admission-status-rectangle').innerHTML = admissionRectangleHtml;
        document.getElementById('admission-status-rectangle').style.display = 'block';
    } else if (admissionRectElement) {
        admissionRectElement.style.display = 'none'; // Hide if not in final scrutinio
    }
    
    hook.innerHTML = sortedSchoolData.length ? sortedSchoolData.map(s => {
        const currentScrutData = s.scrutinio[currentScrutinioPeriod];
        const voto = currentScrutData.voto;
        
        const currentGrades = filterGradesBySpecificPeriod(s.grades || [], currentScrutinioPeriod);
        const currentAvg = calculateArithmeticAvg(currentGrades);
        const suggestedGrade = currentScrutData.previsione || (currentAvg !== null ? Math.round(currentAvg) : null);

        // For special subjects like Comportamento, Educazione Civica, Religione,
        // the average and trend might not be applicable in the same way.
        // We'll display their 'voto' directly if it's set.
        const isSpecialSubject = ["COMPORTAMENTO", "EDUCAZIONE CIVICA", "RELIGIONE"].includes(s.name.toUpperCase());
        
        let trendHtml = '';
        // Analisi Trend: solo se siamo nello Scrutinio Finale e abbiamo dati del Primo Quadrimestre
        if (currentScrutinioPeriod === 'secondo') {
            const prevGrades = filterGradesBySpecificPeriod(s.grades || [], 'primo');
            const prevAvg = calculateArithmeticAvg(prevGrades);
            
            if (currentAvg !== null && prevAvg !== null) {
                const diff = currentAvg - prevAvg;
                if (diff > 0.1) {
                    trendHtml = '<span class="trend-tag trend-positive">▲ Salendo</span>';
                } else if (diff < -0.1) {
                    trendHtml = '<span class="trend-tag trend-negative">▼ Scesa</span>';
                } else {
                    trendHtml = '<span class="trend-tag trend-stable">〓 Stabile</span>';
                }
            }
        }
        ...
        if (voto !== '-') {
            ...
            // Per Comportamento ed Ed. Civica il bollino del voto deve avere il colore della materia
            if (["COMPORTAMENTO", "EDUCAZIONE CIVICA"].includes(s.name.toUpperCase())) {
                colorClass = ""; 
                pillStyle = `style="background-color: ${s.color};"`;
            } else {
        ...
        <tr>
            <td>
                <div class="bold-text-blue" style="color: ${s.color};">${s.name}</div>
                <div class="scrutinio-prediction-area" ${isSpecialSubject ? 'style="display:none;"' : ''}>
                    Media: <b>${currentAvg !== null ? currentAvg.toFixed(1) : '--'}</b>
                    ${trendHtml}
                </div>
            </td>
            <td class="text-center">${currentScrutData.assenze}</td>
            <td class="text-center">
                <div class="scrutinio-grade-display-flex">
                    <div class="scrutinio-pill-box pill-prediction" title="Clicca per modificare la previsione" onclick="editScrutinioPrediction(${s.id})">
                        ${suggestedGrade || '-'}
                    </div>
                    <span class="pill-arrow-sep" title="Clicca per applicare questa previsione" style="cursor:pointer;" onclick="applySuggestedGrade(${s.id}, '${suggestedGrade}')">
                        ➔
                    </span> 
                    <div class="scrutinio-pill-box ${colorClass}" ${pillStyle}>
                        ${formatGradeDisplay(voto)}
                    </div>
                </div>
            </td>
...
function getFileIcon(type) {
    if (!type) return '📄'; // Aggiunto per coerenza
...
function renderSubjectsAccordion() {
    ...
    // Ordine alfabetico richiesto solamente per la lista dei voti giornalieri
    const alphabeticalSubjects = [...schoolData].sort((a, b) => a.name.localeCompare(b.name));

    alphabeticalSubjects.forEach(sub => {
        // Nascondi Comportamento ed Ed. Civica dalla lista dei voti (vanno solo in Scrutinio)
        if (["COMPORTAMENTO", "EDUCAZIONE CIVICA"].includes(sub.name.toUpperCase())) return;
...
function renderSubjectLineChart(subId, grades) {
    ...
    const primaryColor = getComputedStyle(document.documentElement).getPropertyValue('--primary-orange').trim() || '#FF914D'; // Use primary-orange for consistency
    ...
    subjectChartInstance = new Chart(canvas, {
        ...
        options: {
            ...
            scales: {
                y: { min: 2, max: 10, ticks: { stepSize: 1, color: textColor }, grid: { color: gridColor, drawBorder: false } },
...
function populateSubjectSelects() {
    ...
    // Filtriamo le materie per escludere quelle visualizzabili solo nello scrutinio dai menu di inserimento
    const filteredSubjects = schoolData.filter(s => !["COMPORTAMENTO", "EDUCAZIONE CIVICA"].includes(s.name.toUpperCase()));

    ids.forEach(id => {
        const sel = document.getElementById(id);
        if(!sel) return; // Ensure element exists
        if (id === 'grade-subject-select') {
            sel.innerHTML = filteredSubjects.map(s => `<option value="${s.id}">${s.name}</option>`).join('');
            if (filteredSubjects.length > 0) {
                sel.value = filteredSubjects[0].id; 
            } else {
                sel.innerHTML = '<option value="">Nessuna materia disponibile</option>';
            }
        } else if (id === 'tt-subject-select') { // This is for timetable, so it should be populated with subject names
            sel.innerHTML = filteredSubjects.map(s => `<option value="${s.name}">${s.name}</option>`).join('') + '<option value="Altro">Altro / Libero</option>';
        } else {
            sel.innerHTML = filteredSubjects.length ? filteredSubjects.map(s => `<option value="${s.name}">${s.name}</option>`).join('') : '<option value="">Crea prima una materia</option>';
        }
    });
}
 
function populateTimetableSelects() { // This function is redundant, populateSubjectSelects already handles tt-subject-select
    const sel = document.getElementById('tt-subject-select');
    if(!sel) return;
...
function renderAttendancePieChart() {
    ...
    // Calcola il totale delle ore di assenza effettive (Assenze, Ritardi, Uscite)
    // Calcola il totale delle ore di assenza effettive (Assenze, Ritardi, Uscite)
    const totalHoursAbs = (attendanceEvents || []).reduce((sum, e) => sum + (parseFloat(e.hours) || 0), 0);
    
    const totalYearHours = getTotalAnnualHours();
    const percAbs = totalYearHours > 0 ? (totalHoursAbs / totalYearHours) * 100 : 0;
    const legalAbsenceLimit = totalYearHours * 0.25; // Il limite legale è il 25% del monte ore
    
    // Il grafico mostra la percentuale di presenze (verde) rispetto al totale delle ore annuali
    chart.style.setProperty('--p-perc', Math.max(0, 100 - (totalHoursAbs / legalAbsenceLimit * 25)).toFixed(1) + '%');
    
    if(document.getElementById('total-hours-abs')) document.getElementById('total-hours-abs').innerText = Number(totalHoursAbs.toFixed(1));
    if(document.getElementById('max-annual-hours')) document.getElementById('max-annual-hours').innerText = totalYearHours;
    
    const pAbs = document.getElementById('perc-assenze'); if(pAbs) pAbs.innerText = percAbs.toFixed(1);
    const pPre = document.getElementById('perc-presenze'); if(pPre) pPre.innerText = Math.max(0, (100 - percAbs)).toFixed(1);

    // Alert basati sul limite legale (25% del monte ore)
    const warningThreshold = legalAbsenceLimit * 0.80; // Avviso all'80% del limite legale
    
    if (totalHoursAbs > legalAbsenceLimit) {
        showToast(`PERICOLO: Hai superato il limite legale di assenze (${totalHoursAbs.toFixed(1)}h / ${legalAbsenceLimit.toFixed(1)}h)!`, "error");
    } else if (totalHoursAbs > warningThreshold) {
        showToast(`ATTENZIONE: Sei vicino al limite legale di assenze (${totalHoursAbs.toFixed(1)}h / ${legalAbsenceLimit.toFixed(1)}h).`, "warning");
    }
}
...
function drawAreaChart(bucket, has) {
    ...
    const chartColor = '#4CAF50'; // Verde richiesto
...
function saveSubject() {
    ...
    if (editingSubjectId) {
        ...
        // Ensure previsione is initialized for new subjects
        schoolData.at(-1).scrutinio.primo.previsione = null;
        schoolData.at(-1).scrutinio.secondo.previsione = null;
    }
...
function saveGrade() {
    ...
    // Sistema di notifica per date fuori dai periodi configurati
    const termSettings = JSON.parse(localStorage.getItem(getTredKey('myDidupTermDates'))) || {
        p1_start: '2025-09-12', p1_end: '2026-01-31', p2_end: '2026-06-08'
    };
    const gradeTime = parseDateSafe(date).setHours(0,0,0,0);
    const p1Start = parseDateSafe(termSettings.p1_start).setHours(0,0,0,0);
    const p2End = parseDateSafe(termSettings.p2_end).setHours(23,59,59,999);

    if (gradeTime < p1Start || gradeTime > p2End) {
        showToast("Attenzione: La data del voto è fuori dai periodi configurati.", "error");
    }
    ...
    if (editingGradeId) {
        ...
        if (grade) { // Ensure grade exists before assigning
...
/**
 * Inizializza la previsione per tutte le materie e periodi se non già presente.
 */
function initializePrevisione() {
    schoolData.forEach(sub => {
        if (!sub.scrutinio) sub.scrutinio = { primo: { voto: '-', assenze: 0, previsione: null }, secondo: { voto: '-', assenze: 0, previsione: null } };
        ['primo', 'secondo'].forEach(period => {
            if (sub.scrutinio[period] && sub.scrutinio[period].previsione === undefined) {
                sub.scrutinio[period].previsione = null;
            }
        });
    });
}
...
function commitReminder() {
    ...
    // Notifica push/locale per verifiche o interrogazioni
    if (type === 'Verifica' || type === 'Interrogazione') {
        triggerLocalNotification(`Nuova ${type}`, `${subj}: ${title}`);
    }
...
/**
 * Imposta rapidamente la data nel modale appello
 * @param {number} offset - 0 per oggi, -1 per ieri
 */
window.setAttendanceDate = (offset) => {
    const d = new Date();
    d.setDate(d.getDate() + offset);
    document.getElementById('att-date').value = d.toISOString().split('T')[0];
};

/**
 * Imposta rapidamente le ore nel modale appello
 */
window.setAttendanceHours = (h) => {
    document.getElementById('att-hours').value = h;
};

/**
 * Aggiunge una nuova riga alla tabella di inserimento rapido appello
 */
window.addBulkAttendanceRow = () => {
    const tbody = document.getElementById('bulk-attendance-tbody');
    const row = document.createElement('tr');
    const today = new Date().toISOString().substring(0, 10);
    row.innerHTML = `
        <td><input type="date" class="bulk-att-date" value="${today}"></td>
        <td>
            <select class="bulk-att-type">
                <option value="Assenza">Assenza</option>
                <option value="Ritardo">Ritardo</option>
                <option value="Uscita">Uscita</option>
            </select>
        </td>
        <td><input type="number" class="bulk-att-hours" placeholder="Ore" min="1" max="10"></td>
        <td><input type="text" class="bulk-att-reason" placeholder="Nota o motivazione..."></td>
        <td class="text-center"><button class="btn-inline-del" onclick="this.closest('tr').remove()">🗑️</button></td>
    `;
    tbody.appendChild(row);
};

/**
 * Salva massivamente tutti gli eventi inseriti nella tabella Excel
 */
window.commitBulkAttendance = () => {
    const rows = document.querySelectorAll('#bulk-attendance-tbody tr');
    let added = 0;
    const now = Date.now();
    rows.forEach((row, index) => {
        const date = row.querySelector('.bulk-att-date').value;
        const type = row.querySelector('.bulk-att-type').value;
        const hours = parseFloat(row.querySelector('.bulk-att-hours').value) || 0;
        const reason = row.querySelector('.bulk-att-reason').value.trim();
        if (date) {
            attendanceEvents.push({ id: now + index, type, date, hours, reason: reason || "Nota non inserita", justified: false });
            added++;
        }
    });
    if (added > 0) {
        updateStorage('myDidupAttendanceDesktop', attendanceEvents);
        showToast(`Registrati ${added} eventi appello!`);
        closeModal('bulk-attendance-modal');
        renderAppelloSection();
    } else { showToast("Inserisci almeno un evento", "error"); }
};
...
function commitAttendance() {
    ...
    const keepOpen = document.getElementById('att-keep-open')?.checked;

    attendanceEvents.push({ id: Date.now(), type, date, hours: hours, reason: reason || "Nota non inserita", justified: false });
    updateStorage('myDidupAttendanceDesktop', attendanceEvents);

    if (keepOpen) {
        // Pulisce solo i campi variabili, mantiene data e tipo per velocità
        document.getElementById('att-reason').value = '';
        document.getElementById('att-hours').value = '';
        document.getElementById('att-hours').focus();
        showToast("Registrato! Inserisci il prossimo...", "success");
    } else {
        document.getElementById('att-reason').value = '';
        document.getElementById('att-hours').value = '';
...
function justifyEvent(id) {
    ...
    if(e) {
        e.justified = true;
        updateStorage('myDidupAttendanceDesktop', attendanceEvents);
        showToast(`${e.type} giustificato con successo!`, "success");
    }
}
...
function simulateSubjectAvg(subId, val) {
    ...
    recalculateDesktopSystem(); // Recalculate to update global averages and charts
    updatePredictionUI(subId);
}
...
function downloadPDFReport() {
    ...
    // Ordine alfabetico richiesto solamente per il report dei voti giornalieri
    const alphabeticalSubjects = [...schoolData].sort((a, b) => a.name.localeCompare(b.name));

    alphabeticalSubjects.forEach(s => {
        const fGrades = filterGradesByPeriod(s.grades || []);
...
/** Sincronizza il tag versione nell'header della Home */
function renderVersionHeader() {
    const tag = document.getElementById('app-version-header');
    if (tag) {
        tag.innerHTML = `<small style="font-size: 10px; vertical-align: middle; opacity: 0.6;">(v ${CURRENT_VERSION})</small>`;
    }
}

/** Popola automaticamente la card delle novità nella Home */
function renderHomeNews() {
    const container = document.getElementById('home-news-section');
    if (!container) return;

    const latest = APP_NEWS_HISTORY[0];
    if (!latest) return;

    container.innerHTML = `
        <div class="info-card card">
            <h4>🚀 Novità dell'aggiornamento (v ${latest.v})</h4>
            <ul>
                ${latest.news.map(item => `<li>${item}</li>`).join('')}
            </ul>
        </div>
    `;
}
...
/**
 * Renderizza la cronologia delle versioni nella sezione Info.
 */
function renderVersionHistory() {
    const hook = document.getElementById('info-versions-hook');
    if (!hook) return;

    hook.innerHTML = APP_NEWS_HISTORY.map(item => `
        <div class="info-card version-block">
            <div class="flex-row-justify" style="margin-bottom: 10px;">
                <span class="badge-count" style="background:var(--primary-orange); color:white; font-size:10px; border-radius:6px;">VERSIONE ${item.v}</span>
                <span style="font-size:10px; color:var(--text-muted); font-weight:800;">${item.date}</span>
            </div>
            <ul style="margin:0; padding-left:15px; font-size:12px; color:var(--text-sub); line-height:1.6;">
                ${item.news.map(n => `<li>${n}</li>`).join('')}
            </ul>
        </div>
    `).join('');
}
...
/**
 * Aggiorna i badge di notifica all'interno della griglia del menu.
 */
function updateMenuBadges() {
    const infoMenuItem = document.querySelector('.menu-item[onclick*="\'info\'"]');
    if (infoMenuItem) {
        const existing = infoMenuItem.querySelector('.nav-badge');
        if (hasNewVersion()) {
            if (!existing) {
                const badge = document.createElement('span');
                badge.className = 'nav-badge';
                infoMenuItem.appendChild(badge);
            }
        } else if (existing) {
            existing.remove();
        }
...
async function handlePDFImport() {
    ...
    const stopBtn = document.getElementById('btn-stop-pdf-import');
    const spinner = document.getElementById('pdf-loading-spinner');

    if (!fileInput.files.length) return showToast("Seleziona un file", "error");

    const file = fileInput.files[0];
    pdfImportAborted = false;
    btn.style.display = 'none';
    if (stopBtn) stopBtn.style.display = 'inline-block';
    spinner.style.display = 'inline-block';
    status.innerText = "⏳ Inizializzazione PDF...";
    status.style.color = "var(--argo-blue-text)";

    let pdf = null;
    try {
        const arrayBuffer = await file.arrayBuffer();
        // Ottimizzazione: Disabilita i log pesanti per migliorare le performance su mobile
        pdf = await pdfjsLib.getDocument({ data: arrayBuffer, verbosity: 0 }).promise;
        let fullText = "";

        for (let i = 1; i <= pdf.numPages; i++) {
            if (pdfImportAborted) throw new Error("Abort");
            
            status.innerText = `⏳ Elaborazione pagina ${i} di ${pdf.numPages}...`;
            ...
            // Importante per Mobile: Rilascia il thread principale per evitare freeze della UI
            await new Promise(resolve => setTimeout(resolve, 0));
        }

        if (pdfImportAborted) throw new Error("Abort");
        status.innerText = "🔍 Analisi dei voti in corso...";
        parseAndInjectGrades(fullText);
        
        status.innerText = "✅ Importazione completata!";
        ...
        if (error.message === "Abort") {
            status.innerText = "🛑 Importazione interrotta dall'utente.";
        ...
        if (pdf) {
            // Libera la memoria occupata dal documento PDF
            await pdf.destroy();
        }
...
function getWeeklyStudyPlan() {
    ...
    // 1. Identifica le materie insufficienti (media < 6)
    ...
    // Nomi dei giorni della settimana per visualizzazione
    ...
    insufficientSubjects.forEach(sub => {
        ...
        for (let i = 1; i <= 7; i++) { // Inizia da domani (i=1)
            ...
            // Converti currentDayOfWeek (0-6) in timetableDayIdx (0-5 per Lun-Sab)
    ...
    // Ordina il piano di studio per priorità (Alta per prima)
...
async function saveEditedSubjectName(subId, newName) {
    ...
    // Applica l'ordinamento ufficiale invece di quello alfabetico semplice
    sortSubjectsOfficially(schoolData);
...
function openMediaCalculationModal() { // This function is not called anywhere in the provided code.
